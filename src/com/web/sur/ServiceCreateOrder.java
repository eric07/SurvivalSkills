...
public class ServiceCreateOrder {
	 ...
	 * @param order
	 */
	public void insertIntoDB(Order order,Connection connection,String pname){
		...
		try {
			...
			while(rs.next()){
				...
				System.out.println(rs.getString("symbol")+order.getSymbol());
				System.out.println("1: " + rs.getString("symbol").equals(order.getSymbol()));
				System.out.println("2: " + rs.getString("trader_id").equals(order.getTraderID()));
				System.out.println("3: " + rs.getString("side").equals(order.getSide()));
				System.out.println("4: " + rs.getString("type").equals(order.getTradetype()));
				System.out.println(rs.getString("type")+order.getTradetype());
				System.out.println("5: " + rs.getString("status").equals(order.getStatus()));
			...
			ps.setString(9, order.getTimestamp());
