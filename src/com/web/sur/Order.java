...
public class Order {
	private String OrderID, BlockID, Symbol, TraderID, Side, Price, Qty, Date,
			Time, Tradetype, TradeParam, Status;

	/**
	 * Constructor for Order
	 */
	public Order(String OrderID, String BlockID, String Symbol,
			String TraderID, String Side, String Price, String Qty,
			String Date, String Time, String Tradetype, String TradeParam,
			String Status) {
